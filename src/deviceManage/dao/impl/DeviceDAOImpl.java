...
public class DeviceDAOImpl implements DeviceDAO {
     ...
     * @return 真或假
     */
    public Boolean addThresholdInfo(String did, Integer dtid, String name, String classify, String unit, Double cellval,
            Double floorval, Integer ismark, Integer level, String type) {
        HBSessionDaoImpl hbsessionDao = new HBSessionDaoImpl();
        boolean rt = false;
    ...
    public Integer getOneDeviceThresholdByNameAndLevel(String name, String level) {
        ...
        DevicesThreshold kl = (DevicesThreshold) hbsessionDao
                .getFirst("FROM DevicesThreshold where name='" + name + "' and level=" + level);
    ...
    public Boolean addOneDeviceInfo(String deviceType, String devname, String devtype, String serialno,
            String ipaddress, String port, String extra, Integer sms, Integer alert, Integer plantform) {
        HBSessionDaoImpl hbsessionDao = new HBSessionDaoImpl();
        boolean rt = false;
    ...
    public Boolean addOneDeviceInfoToBelongPosition(String deviceType, String devname, String belongname,
        ...
        if (dv == null || belonglevel.equals("0")) {
            ...
            if (belonglevel.equals("1")) {
                ProvinceBank pb = (ProvinceBank) hbsessionDao
                        .getFirst("FROM ProvinceBank where pbname='" + belongname + "分行" + "'");
                ...
                Computerroom pb = (Computerroom) hbsessionDao
                        .getFirst("FROM Computerroom where rname='" + belongname + "'");
    ...
    /*
     * 更新新增的设备所关联的表的信息 1.添加一个设备到device表 2.根据设备所属等级（belonglevel 1：省级； 2：市级；
     * 3：机房级）更新相应表（province、city、computerroom） 2019.03.13 chen use transient
     */
    public Boolean addOneDeviceInfoAndBelongPos(String deviceType, String devname, String devtype, String serialno,
            String iPaddress, String port, String extra, Integer sms, Integer alert, Integer plantform,
            String belongname, String belonglevel) {
        ...
        try {
            ...
            String sql1 = "INSERT INTO devices ( did,name,devicetype,type,serialno,IPaddress,port,extra,isSMS,isAlart,isPlartform ) "
                    + "VALUES ( '" + imaxid + "', '" + deviceType + "','" + devname + "','" + devtype + "','" + serialno
                    + "','" + iPaddress + "','" + port + "','" + extra + "','" + sms + "','" + alert + "','" + plantform
                    + "' )";
            ...
            if (belonglevel.equals("0")) {
                ...
                if (belonglevel.equals("1")) {
                    ...
                    if (deviceType.equals("其他传感器")) {
                        ...
                        String sql2 = "UPDATE province_bank SET tempset='" + tempset + "' WHERE pbname='" + belongname
                                + "'";
                        ps = db.getPs(sql2);
                        ...
                        String sql2 = "UPDATE province_bank SET didset='" + didset + "' WHERE pbname='" + belongname
                                + "'";
                        ps = db.getPs(sql2);
                        ps.executeUpdate(sql2);
                    }
                    ...
                    if (deviceType.equals("其他传感器")) {
                        ...
                        String sql2 = "UPDATE city_bank SET tempset='" + tempset + "' WHERE cbname='" + belongname
                                + "'";
                        ps = db.getPs(sql2);
                        ps.executeUpdate(sql2);
                    } else {
                        ...
                        String sql2 = "UPDATE city_bank SET didset='" + didset + "' WHERE cbname='" + belongname + "'";
                        ps = db.getPs(sql2);
                        ps.executeUpdate(sql2);
                    }
                }
                    ...
                    if (deviceType.equals("其他传感器")) {
                        ...
                        String sql2 = "UPDATE computerroom SET tempset='" + tempset + "' WHERE rname='" + belongname
                                + "'";
                        ps = db.getPs(sql2);
                        ps.executeUpdate(sql2);
                    } else {
                        ...
                        String sql2 = "UPDATE computerroom SET didset='" + didset + "' WHERE rname='" + belongname
                                + "'";
                        ps = db.getPs(sql2);
                        ps.executeUpdate(sql2);
                    }
        ...
        //////////////////// old
        /*
         * HBSessionDaoImpl hbsessionDao = new HBSessionDaoImpl(); boolean rt1 = false,
         * rt2 = false;
         * 
         * Devices dt = new Devices(); String maxdid = getMaxDeviceId(); Integer imaxid
         * = Integer.parseInt(maxdid) + 1;
         * 
         * dt.setDid(imaxid); dt.setDevicetype(deviceType); dt.setName(devname);
         * dt.setType(devtype); dt.setSerialno(serialno); dt.setiPaddress(iPaddress);
         * dt.setPort(port); dt.setExtra(extra); dt.setIsSms(sms); dt.setIsAlart(alert);
         * dt.setIsPlartform(plantform);
         * 
         * rt1 = hbsessionDao.insert(dt);
         * 
         * Devices dv = (Devices) hbsessionDao.getFirst( "FROM Devices where name='" +
         * devname + "'");
         * 
         * if(dv == null || belonglevel.equals("0")) { return false; } else { String did
         * = dv.getDid().toString();
         * 
         * if(belonglevel.equals("1")) { ProvinceBank pb = (ProvinceBank)
         * hbsessionDao.getFirst( "FROM ProvinceBank where pbname='" + belongname + "分行"
         * + "'");
         * 
         * if(deviceType.equals("其他传感器")) { String tempset = pb.getTempset(); if
         * (tempset!= null && tempset.length() > 0) { tempset += "，"; } tempset += did;
         * String hql = "update ProvinceBank pb set tempset='" + tempset +
         * "' where pbname = '" + belongname + "'"; rt2 = hbsessionDao.update(hql); }
         * else { String didset = pb.getDidset(); if (didset!= null && didset.length() >
         * 0) { didset += "，"; } didset += did; String hql =
         * "update ProvinceBank pb set didset='" + didset + "' where pbname = '" +
         * belongname + "'"; rt2 = hbsessionDao.update(hql); } }
         * 
         * else if(belonglevel.equals("2")) { CityBank pb = (CityBank)
         * hbsessionDao.getFirst( "FROM CityBank where cbname='" + belongname + "'");
         * 
         * if(deviceType.equals("其他传感器")) { String tempset = pb.getTempset(); if
         * (tempset!= null && tempset.length() > 0) { tempset += "，"; } tempset += did;
         * String hql = "update CityBank pb set tempset='" + tempset +
         * "' where cbname = '" + belongname + "'"; rt2 = hbsessionDao.update(hql); }
         * else { String didset = pb.getDidset(); if (didset!= null && didset.length() >
         * 0) { didset += "，"; } didset += did; String hql =
         * "update CityBank pb set didset='" + didset + "' where cbname = '" +
         * belongname + "'"; rt2 = hbsessionDao.update(hql); } }
         * 
         * else if(belonglevel.equals("3")) { Computerroom pb = (Computerroom)
         * hbsessionDao.getFirst( "FROM Computerroom where rname='" + belongname + "'");
         * 
         * if(deviceType.equals("其他传感器")) { String tempset = pb.getTempset(); if
         * (tempset!= null && tempset.length() > 0) { tempset += "，"; } tempset += did;
         * String hql = "update Computerroom pb set tempset='" + tempset +
         * "' where rname = '" + belongname + "'"; rt2 = hbsessionDao.update(hql); }
         * else { String didset = pb.getDidset(); if (didset!= null && didset.length() >
         * 0) { didset += "，"; } didset += did; String hql =
         * "update Computerroom pb set didset='" + didset + "' where rname = '" +
         * belongname + "'"; rt2 = hbsessionDao.update(hql); } } }
         * 
         * return rt1 && rt2;
         */
    ...
    public Boolean addOneDeviceAlarmUser(String uid, String level) {
        HBSessionDaoImpl hbsessionDao = new HBSessionDaoImpl();
        boolean rt = false;
        DeviceAlarmUser adu = (DeviceAlarmUser) hbsessionDao
                .getFirst("FROM DeviceAlarmUser where level='" + level + "'");
    ...
    public Boolean modifyOneDeviceInfo(String deviceType, String devname, String devtype, String serialno,
            String IPaddress, String port, String extra, Integer sms, Integer alert, Integer plantform, String did) {
        HBSessionDaoImpl hbsessionDao = new HBSessionDaoImpl();
        Boolean rt = false;
        ...
        String hql = "update Devices kl set kl.devicetype='" + deviceType + "', kl.type='" + devtype
                ...
                + "', kl.extra='" + extra + "', kl.isSms='" + sms + "', kl.isAlart='" + alert + "', kl.isPlartform='"
                + plantform + "', kl.name='" + devname + "' where kl.did='" + did + "'";
    ...
    public Boolean updateDeviceThreshold(String dtid, String type, String unit, Double cellval, Double floorval,
        ...
        String hql = "update DevicesThreshold kl set kl.classify='" + type + "', kl.unit='" + unit + "', kl.cellval="
                + cellval + ", kl.floorval=" + floorval + ", kl.ismark=" + ismark + ", kl.level='" + level
                + "' where kl.dtid='" + dtid + "'";
    ...
    public Boolean updateThresholdInfo(String did, Integer dtid, String name, String classify, String unit,
        ...
        String hql = "update DevicesThreshold kl set kl.dtid='" + dtid + "', kl.classify='" + classify + "', kl.did='"
                + did + "', kl.unit='" + unit + "', kl.cellval='" + cellval + "', kl.floorval='" + floorval
                + "', kl.ismark='" + ismark + "' where kl.name='" + name + "' and kl.level=" + level;
    ...
    public String getdttypeBydtid(String dtid) {
        ...
        DevicesThreshold dt = (DevicesThreshold) hbsessionDao
                .getFirst("FROM DevicesThreshold where dtid='" + dtid + "'");
    ...
    public Boolean isValidValue(String type, Double dcellval, Double dfloorval, String level) {
        ...
        DevicesThreshold dt1 = (DevicesThreshold) hbsessionDao
                .getFirst("FROM DevicesThreshold where type='" + type + "' and level = '1'");
        DevicesThreshold dt2 = (DevicesThreshold) hbsessionDao
                .getFirst("FROM DevicesThreshold where type='" + type + "' and level = '2'");
        DevicesThreshold dt3 = (DevicesThreshold) hbsessionDao
                .getFirst("FROM DevicesThreshold where type='" + type + "' and level = '3'");
