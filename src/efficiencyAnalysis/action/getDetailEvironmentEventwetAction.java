...
public class getDetailEvironmentEventwetAction extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        try {//获取数据
            ...
            // 查询当前页实体对象
            pageHelper = dao.getEnvironmentEventwetObjectListPage(cbnamelist, starttime, endtime, start, end);
            pageHelper.setPage((end+1)/Integer.parseInt(limit) );

            // 统计总记录数
            Integer total = dao.getLocalAllEnvironmentwetTotal(cbnamelist, starttime, endtime);
