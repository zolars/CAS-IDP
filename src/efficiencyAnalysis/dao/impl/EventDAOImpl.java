...
public class EventDAOImpl implements EventDAO {
    ...
    public boolean addSignAndAnnotDeviceEvent(String teid, String sign, String annot) {
        ...
        boolean rt = false;
        String hql = "update EventCtrl ep set ep.signature='" + sign + "', ep.annotation='" + annot
                + "' where ep.teid='" + teid + "'";
    ...
    public boolean addSignAndAnnotPowerEvent(String teid, String sign, String annot) {
        HBSessionDaoImpl hbsessionDao = new HBSessionDaoImpl();
        boolean rt = false;
        String hql = "update EventPower ep set ep.signature='" + sign + "', ep.annotation='" + annot
                + "' where ep.teid='" + teid + "'";
    ...
    public boolean addSignAndAnnotEnvironEvent(String teid, String sign, String annot) {
        HBSessionDaoImpl hbsessionDao = new HBSessionDaoImpl();
        boolean rt = false;
        String hql = "update EventEnvironment ep set ep.signature='" + sign + "', ep.annotation='" + annot
                + "' where ep.teid='" + teid + "'";
    ...
    public List getLocalAllPowerEvent(String cbid, String starttime, String endtime) {
        ...
        for (int i = 0; i < comidset.length; i++) {
            Computerroom cp = (Computerroom) hbsessionDao
                    .getFirst("FROM Computerroom where rid = '" + comidset[i] + "'");
    ...
    public List getLocalAllDetailPowerEventlytx(String cbid, String starttime, String endtime) {
        ...
        String sql = "select ta.teid as teid, tb.classify as name, td.name as location, tb.description as type, ta.value as description, "
                ...
                + "from event_power ta,events_type tb,devices td where ta.cid = tb.cid  and td.did=ta.did "
                + " and ta.time >'" + starttime + "' and ta.time <'" + endtime
    ...
    public List getLocalAllDetailPowerEventxb(String cbid, String starttime, String endtime) {
        ...
        String sql = "select ta.teid as teid, tb.classify as name, td.name as location, tb.description as type, ta.value as description, ta.time as time, ta.cid as cid, ta.signature as signature, ta.annotation as annotation, ta.duration as duration "
                + "from event_power ta,events_type tb,devices td where ta.cid = tb.cid   and td.did=ta.did "
                + " and ta.time >'" + starttime + "' and ta.time <'" + endtime
                + "' and tb.subtype between 23 and 322 ORDER BY signature limit 2000";
    ...
    public List getLocalAllEnvironmentEvent(String cbid, String starttime, String endtime) {
        ...
        String sql = "select DISTINCT ta.teid as teid, tb.classify as name, td.name as location, tb.description as type, ta.value as description, ta.time as time, ta.cid as cid, ta.signature as signature, ta.annotation as annotation, ta.duration as duration "
                ...
                + "where tb.cid = ta.cid and tb.type = tc.type  and td.did=ta.did " + " and ta.time >'" + starttime
                + "' and ta.time <'" + endtime + "' ORDER BY signature limit 2000";
    ...
    public List getLocalLastEnvironmentEvent(String cbid) {
        ...
        String sql = "select ta.teid as teid, tb.classify as name, td.name as location, tb.description as type, ta.value as description, ta.time as time, ta.signature as signature, ta.annotation as annotation "
                + "from event_environment ta,events_type tb, devices_threshold tc,devices td    "
                + "where tc.type = tb.type and ta.cid = tb.cid and td.did=ta.did" + " ORDER BY signature limit 2000";
        try {
            ps = db.getPs(sql);
            rs = ps.executeQuery();
            if (rs.next()) {
    ...
    public int getLocalAllEnvironmentTotal(String cbnamelist[], String starttime, String endtime) {
        ...
        for (int k = 0; k < cbnamelist.length; k++) {
            ...
            for (int i = 0; i < didset.length; i++) {
                ...
                String sql = "select DISTINCT ta.teid as teid, tb.classify as name, td.name as location, tb.description as type, ta.value as description, ta.time as time, ta.cid as cid, ta.signature as signature, ta.annotation as annotation, ta.duration as duration "
                        + "from event_environment ta,events_type tb, devices_threshold tc,devices td "
                        + "where tb.cid = ta.cid and tb.type = tc.type and td.did =ta.did " + "' and ta.did ='"
                        + didset[i] + "' and ta.time >'" + starttime + "' and ta.time <'" + endtime
                        + "' ORDER BY signature limit 2000";
                try {
                    ps = db.getPs(sql);
                    rs = ps.executeQuery();
    ...
    // 获取分页的电能事件xb
    public PageHelper<EventObject> getPowerEventxbObjectListPage(String cbnamelist[], String starttime, String endtime,
            Integer start, Integer end) {
        HBSessionDaoImpl hbsessionDao = new HBSessionDaoImpl();
    ...
    public PageHelper<EventObject> getEnvironmentEventtempObjectListPage(String cbnamelist[], String starttime,
        ...
        for (int k = 0; k < cbnamelist.length; k++) {
            ...
            String sql = "select DISTINCT ta.teid as teid, tb.classify as name, td.name as location, tb.description as type, ta.value as description, ta.time as time, ta.cid as cid, ta.signature as signature, ta.annotation as annotation, ta.duration as duration "
                    + "from event_environment ta,events_type tb, devices_threshold tc,devices td "
                    + "where tb.cid = ta.cid and tb.type = tc.type and td.did =ta.did " + " and ta.time >'" + starttime
                    + "' and ta.time <'" + endtime + "' and tb.type in (113,114) ORDER BY signature limit 2000";
            try {
                ps = db.getPs(sql);
                rs = ps.executeQuery();
                for (int idx = 0; (idx < 10000) && rs.next(); idx++) {
    ...
    public PageHelper<EventObject> getEnvironmentEventwetObjectListPage(String cbnamelist[], String starttime,
        ...
        for (int k = 0; k < cbnamelist.length; k++) {
            ...
            String sql = "select DISTINCT ta.teid as teid, tb.classify as name, td.name as location, tb.description as type, ta.value as description, ta.time as time, ta.cid as cid, ta.signature as signature, ta.annotation as annotation, ta.duration as duration "
                    + "from event_environment ta,events_type tb, devices_threshold tc,devices td "
                    + "where tb.cid = ta.cid and tb.type = tc.type and td.did =ta.did " + " and ta.time >'" + starttime
                    + "' and ta.time <'" + endtime + "' and tb.type in (115,116) ORDER BY signature limit 2000";
            try {
                ps = db.getPs(sql);
                rs = ps.executeQuery();
                for (int idx = 0; (idx < 10000) && rs.next(); idx++) {
    ...
    public Map getAllProvinceEvent() {
        ...
        for (int j = 0; j < provblist.size(); j++) {
                ...
                for (int i = 0; i < cbidstr.length; i++) {
                    ...
                    if (comproomset != null && comproomset.length() > 0) {
                        ...
                        for (int ii = 0; ii < compstr.length; ii++) {
                            List<Computerroom> complist = hbsessionDao
                                    .search("FROM Computerroom where rid='" + compstr[ii] + "'");
            ...
            if (!didsetstring.equals("(")) { // 有电能质量类的事件
                ...
                List<AssessRecord> assessrecordlist = hbsessionDao
                        .search(" FROM AssessRecord where did in " + didsetstring);
        ...
        if (cbidset == null || cbidset.equals("")) { // 省行下无市行
            ...
            for (int i = 0; i < cbidstr.length; i++) {
                ...
                if (!didsetstring.equals("(") || !tempsetstring.equals("(") || !cidsetstring.equals("(")) { // 有电能质量类的事件
                    ...
                    // 电能类事件类型为1
                    String sql1 = "select degree,eventclass from assess_record ta, event_power tb where ta.teid = tb.teid and (tb.signature is NULL or tb.signature = '') and ta.did IN "
                            + didsetstring;

                    // 温度类事件类型为2//湿度类事件类型为3
                    String sql23 = "select degree,eventclass from assess_record ta, event_environment tb where ta.teid = tb.teid and (tb.signature is NULL or tb.signature = '') and ta.did IN "
                            + tempsetstring;

                    // 治理类事件类型为4
                    String sql4 = "select degree,eventclass from assess_record ta, event_ctrl tb where ta.teid = tb.teid and (tb.signature is NULL or tb.signature = '') and ta.did IN "
                            + cidsetstring;
            ...
            if (tempset.equals(null) || tempset == null) {
                ...
                if (null != tempDataMap) {
                    for (int i = 0; i < tempstr.length; i++) {
                        ...
                        List<String> list = hbsessionDao
                                .search("select name as dname from  Devices  where did =" + tempstr[i]);
                        if (list != null) {
                            aa.add(list.get(0));
                            aa.add("0.00");
                            aa.add("0.00");
        ...
        if (comps != null) {
            ...
            if (didset.equals(null) || didset == null) {
                ...
                for (int i = 0; i < didstr.length; i++) {
                    String sql = "select count(*) as num1 from event_power ta, devices tb where ta.did = tb.did and ta.did = "
                            + didstr[i] + " and (ta.signature is NULL or ta.signature = '')"; // and ta.time >'" +
                                                                                              // sdf.format(date) + "'
            ...
            if (cidset.equals(null) || cidset == null) {
                ...
                for (int i = 0; i < cidstr.length; i++) {
                    String sql = "select count(*) as num2 from event_ctrl ta, devices tb where ta.did = tb.did and ta.did = "
                            + cidstr[i] + " and (ta.signature is NULL or ta.signature = '')";
            ...
            if (tempset.equals(null) || tempset == null) {
                ...
                for (int i = 0; i < tempstr.length; i++) {
                    String sql = "select count(*) as num3 from event_environment ta, devices tb where ta.did = tb.did and ta.did = "
                            + tempstr[i] + " and (ta.signature is NULL or ta.signature = '')";
    ...
    public List getCtrlDevices(String rname) {
        ...
        if (comps != null) {
            ...
            if (cidstr != null) {
                for (int i = 0; i < cidstr.length; i++) {
                    Devices dv = (Devices) hbsessionDao
                            .getFirst("FROM Devices where did='" + cidstr[i] + "' and type = 'ctrl'");
                    if (dv != null) {
    ...
    public List getIDPDevices(String rname) {
        ...
        if (comps != null) {
            ...
            if (didstr != null) {
                for (int i = 0; i < didstr.length; i++) {
                    Devices dv = (Devices) hbsessionDao
                            .getFirst("FROM Devices where did='" + didstr[i] + "' and type = 'IDP'");
                    if (dv != null) {
                        didlist.add(dv.getDid().toString());
                    }
                }
    ...
    public String getDeviceCtrlStatus(String did, String stime, String etime) {
        ...
        List<EventCtrl> list = hbsessionDao
                .search("from EventCtrl where (signature is NULL or signature = '') and did='" + did + "' and time > '"
                        + stime + "' and time < '" + etime + "' order by time desc");
        ...
        if (list == null) {
            ...
            DictionaryCtrl dictionaryCtrl = (DictionaryCtrl) hbsessionDao
                    .getFirst("from DictionaryCtrl where id='" + cid + "'");
    ...
    public String getDeviceIDPStatus(String did, String stime, String etime) {
        ...
        if (null != parmMap) {
            ...
            if (txflag) {
                List<EventPower> list = hbsessionDao
                        .search("from EventPower where (signature is NULL or signature = '') and did='" + did
                                + "' and time > '" + stime + "' and time < '" + etime + "' order by time desc");
                ...
                if (list == null) {
                    ...
                    EventsType dictionary = (EventsType) hbsessionDao
                            .getFirst("from EventsType where id='" + cid + "'");
    ...
    public boolean setAllEventtypePriorty(String[] eventtypelist, String[] priortylist) {
        ...
        for (int i = 0; i < eventtypelist.length; i++) {
            String hql = "update EventsType et set et.prior='" + priortylist[i] + "' where et.type='" + eventtypelist[i]
                    + "'";
    ...
    public boolean setCaptrueSettingInfo(String onlineinterval, String qstinterval, String thansentinterval,
            String uploadinterval, String assessinterval, String alarminterval, String tempinterval,
            String ctrlinterval, String thresholdsaveinterval, String qstdatainterval) {

        HBSessionDaoImpl hbsessionDao = new HBSessionDaoImpl();
        boolean rt = false;

        String hql = "update BasicSetting bs set bs.onlineinterval=" + onlineinterval + ", bs.qstinterval="
                + qstinterval + ", bs.thansentinterval=" + thansentinterval + ", bs.uploadinterval=" + uploadinterval
                + ", bs.assessinterval=" + assessinterval + ", bs.alarminterval=" + alarminterval + ", bs.tempinterval="
                + tempinterval + ", bs.ctrlinterval=" + ctrlinterval + ", bs.thresholdsaveinterval="
                + thresholdsaveinterval + ", bs.datainterval=" + qstdatainterval + " where bs.id=0";
