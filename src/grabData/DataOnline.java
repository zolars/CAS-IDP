...
public class DataOnline {
    ...
    //存各个监测点parm
//    private static Map<String,String[]> mysql = new HashMap<>();
    ...
    public static void tempSave(String did, Map<String, Float> dataset) {
        ...
        //U1谐波
        varxb.setU1Xb1(dataset.get("U1xb_1")/100);
        varxb.setU1Xb2(dataset.get("U1xb_2")*10);
        varxb.setU1Xb3(dataset.get("U1xb_3")*10);
        varxb.setU1Xb4(dataset.get("U1xb_4")*10);
        varxb.setU1Xb5(dataset.get("U1xb_5")*10);
        varxb.setU1Xb6(dataset.get("U1xb_6")*10);
        varxb.setU1Xb7(dataset.get("U1xb_7")*10);
        varxb.setU1Xb8(dataset.get("U1xb_8")*10);
        varxb.setU1Xb9(dataset.get("U1xb_9")*10);
        varxb.setU1Xb10(dataset.get("U1xb_10")*10);
        varxb.setU1Xb11(dataset.get("U1xb_11")*10);
        varxb.setU1Xb12(dataset.get("U1xb_12")*10);
        varxb.setU1Xb13(dataset.get("U1xb_13")*10);
        varxb.setU1Xb14(dataset.get("U1xb_14")*10);
        varxb.setU1Xb15(dataset.get("U1xb_15")*10);
        varxb.setU1Xb16(dataset.get("U1xb_16")*10);
        varxb.setU1Xb17(dataset.get("U1xb_17")*10);
        varxb.setU1Xb18(dataset.get("U1xb_18")*10);
        varxb.setU1Xb19(dataset.get("U1xb_19")*10);
        varxb.setU1Xb20(dataset.get("U1xb_20")*10);
        varxb.setU1Xb21(dataset.get("U1xb_21")*10);
        varxb.setU1Xb22(dataset.get("U1xb_22")*10);
        varxb.setU1Xb23(dataset.get("U1xb_23")*10);
        varxb.setU1Xb24(dataset.get("U1xb_24")*10);
        varxb.setU1Xb25(dataset.get("U1xb_25")*10);
        varxb.setU1Xb26(dataset.get("U1xb_26")*10);
        varxb.setU1Xb27(dataset.get("U1xb_27")*10);
        varxb.setU1Xb28(dataset.get("U1xb_28")*10);
        varxb.setU1Xb29(dataset.get("U1xb_29")*10);
        varxb.setU1Xb30(dataset.get("U1xb_30")*10);
        varxb.setU1Xb31(dataset.get("U1xb_31")*10);
        varxb.setU1Xb32(dataset.get("U1xb_32")*10);
        varxb.setU1Xb33(dataset.get("U1xb_33")*10);
        varxb.setU1Xb34(dataset.get("U1xb_34")*10);
        varxb.setU1Xb35(dataset.get("U1xb_35")*10);
        varxb.setU1Xb36(dataset.get("U1xb_36")*10);
        varxb.setU1Xb37(dataset.get("U1xb_37")*10);
        varxb.setU1Xb38(dataset.get("U1xb_38")*10);
        varxb.setU1Xb39(dataset.get("U1xb_39")*10);
        varxb.setU1Xb40(dataset.get("U1xb_40")*10);
        varxb.setU1Xb41(dataset.get("U1xb_41")*10);
        varxb.setU1Xb42(dataset.get("U1xb_42")*10);
        varxb.setU1Xb43(dataset.get("U1xb_43")*10);
        varxb.setU1Xb44(dataset.get("U1xb_44")*10);
        varxb.setU1Xb45(dataset.get("U1xb_45")*10);
        varxb.setU1Xb46(dataset.get("U1xb_46")*10);
        varxb.setU1Xb47(dataset.get("U1xb_47")*10);
        varxb.setU1Xb48(dataset.get("U1xb_48")*10);
        varxb.setU1Xb49(dataset.get("U1xb_49")*10);
        varxb.setU1Xb50(dataset.get("U1xb_50")*10);

        //U2谐波
        varxb.setU2Xb1(dataset.get("U2xb_1")/100);
        varxb.setU2Xb2(dataset.get("U2xb_2")*10);
        varxb.setU2Xb3(dataset.get("U2xb_3")*10);
        varxb.setU2Xb4(dataset.get("U2xb_4")*10);
        varxb.setU2Xb5(dataset.get("U2xb_5")*10);
        varxb.setU2Xb6(dataset.get("U2xb_6")*10);
        varxb.setU2Xb7(dataset.get("U2xb_7")*10);
        varxb.setU2Xb8(dataset.get("U2xb_8")*10);
        varxb.setU2Xb9(dataset.get("U2xb_9")*10);
        varxb.setU2Xb10(dataset.get("U2xb_10")*10);
        varxb.setU2Xb11(dataset.get("U2xb_11")*10);
        varxb.setU2Xb12(dataset.get("U2xb_12")*10);
        varxb.setU2Xb13(dataset.get("U2xb_13")*10);
        varxb.setU2Xb14(dataset.get("U2xb_14")*10);
        varxb.setU2Xb15(dataset.get("U2xb_15")*10);
        varxb.setU2Xb16(dataset.get("U2xb_16")*10);
        varxb.setU2Xb17(dataset.get("U2xb_17")*10);
        varxb.setU2Xb18(dataset.get("U2xb_18")*10);
        varxb.setU2Xb19(dataset.get("U2xb_19")*10);
        varxb.setU2Xb20(dataset.get("U2xb_20")*10);
        varxb.setU2Xb21(dataset.get("U2xb_21")*10);
        varxb.setU2Xb22(dataset.get("U2xb_22")*10);
        varxb.setU2Xb23(dataset.get("U2xb_23")*10);
        varxb.setU2Xb24(dataset.get("U2xb_24")*10);
        varxb.setU2Xb25(dataset.get("U2xb_25")*10);
        varxb.setU2Xb26(dataset.get("U2xb_26")*10);
        varxb.setU2Xb27(dataset.get("U2xb_27")*10);
        varxb.setU2Xb28(dataset.get("U2xb_28")*10);
        varxb.setU2Xb29(dataset.get("U2xb_29")*10);
        varxb.setU2Xb30(dataset.get("U2xb_30")*10);
        varxb.setU2Xb31(dataset.get("U2xb_31")*10);
        varxb.setU2Xb32(dataset.get("U2xb_32")*10);
        varxb.setU2Xb33(dataset.get("U2xb_33")*10);
        varxb.setU2Xb34(dataset.get("U2xb_34")*10);
        varxb.setU2Xb35(dataset.get("U2xb_35")*10);
        varxb.setU2Xb36(dataset.get("U2xb_36")*10);
        varxb.setU2Xb37(dataset.get("U2xb_37")*10);
        varxb.setU2Xb38(dataset.get("U2xb_38")*10);
        varxb.setU2Xb39(dataset.get("U2xb_39")*10);
        varxb.setU2Xb40(dataset.get("U2xb_40")*10);
        varxb.setU2Xb41(dataset.get("U2xb_41")*10);
        varxb.setU2Xb42(dataset.get("U2xb_42")*10);
        varxb.setU2Xb43(dataset.get("U2xb_43")*10);
        varxb.setU2Xb44(dataset.get("U2xb_44")*10);
        varxb.setU2Xb45(dataset.get("U2xb_45")*10);
        varxb.setU2Xb46(dataset.get("U2xb_46")*10);
        varxb.setU2Xb47(dataset.get("U2xb_47")*10);
        varxb.setU2Xb48(dataset.get("U2xb_48")*10);
        varxb.setU2Xb49(dataset.get("U2xb_49")*10);
        varxb.setU2Xb50(dataset.get("U2xb_50")*10);

        //U3谐波
        varxb.setU3Xb1(dataset.get("U3xb_1")/100);
        varxb.setU3Xb2(dataset.get("U3xb_2")*10);
        varxb.setU3Xb3(dataset.get("U3xb_3")*10);
        varxb.setU3Xb4(dataset.get("U3xb_4")*10);
        varxb.setU3Xb5(dataset.get("U3xb_5")*10);
        varxb.setU3Xb6(dataset.get("U3xb_6")*10);
        varxb.setU3Xb7(dataset.get("U3xb_7")*10);
        varxb.setU3Xb8(dataset.get("U3xb_8")*10);
        varxb.setU3Xb9(dataset.get("U3xb_9")*10);
        varxb.setU3Xb10(dataset.get("U3xb_10")*10);
        varxb.setU3Xb11(dataset.get("U3xb_11")*10);
        varxb.setU3Xb12(dataset.get("U3xb_12")*10);
        varxb.setU3Xb13(dataset.get("U3xb_13")*10);
        varxb.setU3Xb14(dataset.get("U3xb_14")*10);
        varxb.setU3Xb15(dataset.get("U3xb_15")*10);
        varxb.setU3Xb16(dataset.get("U3xb_16")*10);
        varxb.setU3Xb17(dataset.get("U3xb_17")*10);
        varxb.setU3Xb18(dataset.get("U3xb_18")*10);
        varxb.setU3Xb19(dataset.get("U3xb_19")*10);
        varxb.setU3Xb20(dataset.get("U3xb_20")*10);
        varxb.setU3Xb21(dataset.get("U3xb_21")*10);
        varxb.setU3Xb22(dataset.get("U3xb_22")*10);
        varxb.setU3Xb23(dataset.get("U3xb_23")*10);
        varxb.setU3Xb24(dataset.get("U3xb_24")*10);
        varxb.setU3Xb25(dataset.get("U3xb_25")*10);
        varxb.setU3Xb26(dataset.get("U3xb_26")*10);
        varxb.setU3Xb27(dataset.get("U3xb_27")*10);
        varxb.setU3Xb28(dataset.get("U3xb_28")*10);
        varxb.setU3Xb29(dataset.get("U3xb_29")*10);
        varxb.setU3Xb30(dataset.get("U3xb_30")*10);
        varxb.setU3Xb31(dataset.get("U3xb_31")*10);
        varxb.setU3Xb32(dataset.get("U3xb_32")*10);
        varxb.setU3Xb33(dataset.get("U3xb_33")*10);
        varxb.setU3Xb34(dataset.get("U3xb_34")*10);
        varxb.setU3Xb35(dataset.get("U3xb_35")*10);
        varxb.setU3Xb36(dataset.get("U3xb_36")*10);
        varxb.setU3Xb37(dataset.get("U3xb_37")*10);
        varxb.setU3Xb38(dataset.get("U3xb_38")*10);
        varxb.setU3Xb39(dataset.get("U3xb_39")*10);
        varxb.setU3Xb40(dataset.get("U3xb_40")*10);
        varxb.setU3Xb41(dataset.get("U3xb_41")*10);
        varxb.setU3Xb42(dataset.get("U3xb_42")*10);
        varxb.setU3Xb43(dataset.get("U3xb_43")*10);
        varxb.setU3Xb44(dataset.get("U3xb_44")*10);
        varxb.setU3Xb45(dataset.get("U3xb_45")*10);
        varxb.setU3Xb46(dataset.get("U3xb_46")*10);
        varxb.setU3Xb47(dataset.get("U3xb_47")*10);
        varxb.setU3Xb48(dataset.get("U3xb_48")*10);
        varxb.setU3Xb49(dataset.get("U3xb_49")*10);
        varxb.setU3Xb50(dataset.get("U3xb_50")*10);
        //I1谐波
        varxb.setI1Xb1(dataset.get("I1xb_1")/100);
        varxb.setI1Xb2(dataset.get("I1xb_2")/100);
        varxb.setI1Xb3(dataset.get("I1xb_3")/100);
        varxb.setI1Xb4(dataset.get("I1xb_4")/100);
        varxb.setI1Xb5(dataset.get("I1xb_5")/100);
        varxb.setI1Xb6(dataset.get("I1xb_6")/100);
        varxb.setI1Xb7(dataset.get("I1xb_7")/100);
        varxb.setI1Xb8(dataset.get("I1xb_8")/100);
        varxb.setI1Xb9(dataset.get("I1xb_9")/100);
        varxb.setI1Xb10(dataset.get("I1xb_10")/100);
        varxb.setI1Xb11(dataset.get("I1xb_11")/100);
        varxb.setI1Xb12(dataset.get("I1xb_12")/100);
        varxb.setI1Xb13(dataset.get("I1xb_13")/100);
        varxb.setI1Xb14(dataset.get("I1xb_14")/100);
        varxb.setI1Xb15(dataset.get("I1xb_15")/100);
        varxb.setI1Xb16(dataset.get("I1xb_16")/100);
        varxb.setI1Xb17(dataset.get("I1xb_17")/100);
        varxb.setI1Xb18(dataset.get("I1xb_18")/100);
        varxb.setI1Xb19(dataset.get("I1xb_19")/100);
        varxb.setI1Xb20(dataset.get("I1xb_20")/100);
        varxb.setI1Xb21(dataset.get("I1xb_21")/100);
        varxb.setI1Xb22(dataset.get("I1xb_22")/100);
        varxb.setI1Xb23(dataset.get("I1xb_23")/100);
        varxb.setI1Xb24(dataset.get("I1xb_24")/100);
        varxb.setI1Xb25(dataset.get("I1xb_25")/100);
        varxb.setI1Xb26(dataset.get("I1xb_26")/100);
        varxb.setI1Xb27(dataset.get("I1xb_27")/100);
        varxb.setI1Xb28(dataset.get("I1xb_28")/100);
        varxb.setI1Xb29(dataset.get("I1xb_29")/100);
        varxb.setI1Xb30(dataset.get("I1xb_30")/100);
        varxb.setI1Xb31(dataset.get("I1xb_31")/100);
        varxb.setI1Xb32(dataset.get("I1xb_32")/100);
        varxb.setI1Xb33(dataset.get("I1xb_33")/100);
        varxb.setI1Xb34(dataset.get("I1xb_34")/100);
        varxb.setI1Xb35(dataset.get("I1xb_35")/100);
        varxb.setI1Xb36(dataset.get("I1xb_36")/100);
        varxb.setI1Xb37(dataset.get("I1xb_37")/100);
        varxb.setI1Xb38(dataset.get("I1xb_38")/100);
        varxb.setI1Xb39(dataset.get("I1xb_39")/100);
        varxb.setI1Xb40(dataset.get("I1xb_40")/100);
        varxb.setI1Xb41(dataset.get("I1xb_41")/100);
        varxb.setI1Xb42(dataset.get("I1xb_42")/100);
        varxb.setI1Xb43(dataset.get("I1xb_43")/100);
        varxb.setI1Xb44(dataset.get("I1xb_44")/100);
        varxb.setI1Xb45(dataset.get("I1xb_45")/100);
        varxb.setI1Xb46(dataset.get("I1xb_46")/100);
        varxb.setI1Xb47(dataset.get("I1xb_47")/100);
        varxb.setI1Xb48(dataset.get("I1xb_48")/100);
        varxb.setI1Xb49(dataset.get("I1xb_49")/100);
        varxb.setI1Xb50(dataset.get("I1xb_50")/100);
        //I2谐波
        varxb.setI2Xb1(dataset.get("I2xb_1")/100);
        varxb.setI2Xb2(dataset.get("I2xb_2")/100);
        varxb.setI2Xb3(dataset.get("I2xb_3")/100);
        varxb.setI2Xb4(dataset.get("I2xb_4")/100);
        varxb.setI2Xb5(dataset.get("I2xb_5")/100);
        varxb.setI2Xb6(dataset.get("I2xb_6")/100);
        varxb.setI2Xb7(dataset.get("I2xb_7")/100);
        varxb.setI2Xb8(dataset.get("I2xb_8")/100);
        varxb.setI2Xb9(dataset.get("I2xb_9")/100);
        varxb.setI2Xb10(dataset.get("I2xb_10")/100);
        varxb.setI2Xb11(dataset.get("I2xb_11")/100);
        varxb.setI2Xb12(dataset.get("I2xb_12")/100);
        varxb.setI2Xb13(dataset.get("I2xb_13")/100);
        varxb.setI2Xb14(dataset.get("I2xb_14")/100);
        varxb.setI2Xb15(dataset.get("I2xb_15")/100);
        varxb.setI2Xb16(dataset.get("I2xb_16")/100);
        varxb.setI2Xb17(dataset.get("I2xb_17")/100);
        varxb.setI2Xb18(dataset.get("I2xb_18")/100);
        varxb.setI2Xb19(dataset.get("I2xb_19")/100);
        varxb.setI2Xb20(dataset.get("I2xb_20")/100);
        varxb.setI2Xb21(dataset.get("I2xb_21")/100);
        varxb.setI2Xb22(dataset.get("I2xb_22")/100);
        varxb.setI2Xb23(dataset.get("I2xb_23")/100);
        varxb.setI2Xb24(dataset.get("I2xb_24")/100);
        varxb.setI2Xb25(dataset.get("I2xb_25")/100);
        varxb.setI2Xb26(dataset.get("I2xb_26")/100);
        varxb.setI2Xb27(dataset.get("I2xb_27")/100);
        varxb.setI2Xb28(dataset.get("I2xb_28")/100);
        varxb.setI2Xb29(dataset.get("I2xb_29")/100);
        varxb.setI2Xb30(dataset.get("I2xb_30")/100);
        varxb.setI2Xb31(dataset.get("I2xb_31")/100);
        varxb.setI2Xb32(dataset.get("I2xb_32")/100);
        varxb.setI2Xb33(dataset.get("I2xb_33")/100);
        varxb.setI2Xb34(dataset.get("I2xb_34")/100);
        varxb.setI2Xb35(dataset.get("I2xb_35")/100);
        varxb.setI2Xb36(dataset.get("I2xb_36")/100);
        varxb.setI2Xb37(dataset.get("I2xb_37")/100);
        varxb.setI2Xb38(dataset.get("I2xb_38")/100);
        varxb.setI2Xb39(dataset.get("I2xb_39")/100);
        varxb.setI2Xb40(dataset.get("I2xb_40")/100);
        varxb.setI2Xb41(dataset.get("I2xb_41")/100);
        varxb.setI2Xb42(dataset.get("I2xb_42")/100);
        varxb.setI2Xb43(dataset.get("I2xb_43")/100);
        varxb.setI2Xb44(dataset.get("I2xb_44")/100);
        varxb.setI2Xb45(dataset.get("I2xb_45")/100);
        varxb.setI2Xb46(dataset.get("I2xb_46")/100);
        varxb.setI2Xb47(dataset.get("I2xb_47")/100);
        varxb.setI2Xb48(dataset.get("I2xb_48")/100);
        varxb.setI2Xb49(dataset.get("I2xb_49")/100);
        varxb.setI2Xb50(dataset.get("I2xb_50")/100);
        //I3谐波
        varxb.setI3Xb1(dataset.get("I3xb_1")/100);
        varxb.setI3Xb2(dataset.get("I3xb_2")/100);
        varxb.setI3Xb3(dataset.get("I3xb_3")/100);
        varxb.setI3Xb4(dataset.get("I3xb_4")/100);
        varxb.setI3Xb5(dataset.get("I3xb_5")/100);
        varxb.setI3Xb6(dataset.get("I3xb_6")/100);
        varxb.setI3Xb7(dataset.get("I3xb_7")/100);
        varxb.setI3Xb8(dataset.get("I3xb_8")/100);
        varxb.setI3Xb9(dataset.get("I3xb_9")/100);
        varxb.setI3Xb10(dataset.get("I3xb_10")/100);
        varxb.setI3Xb11(dataset.get("I3xb_11")/100);
        varxb.setI3Xb12(dataset.get("I3xb_12")/100);
        varxb.setI3Xb13(dataset.get("I3xb_13")/100);
        varxb.setI3Xb14(dataset.get("I3xb_14")/100);
        varxb.setI3Xb15(dataset.get("I3xb_15")/100);
        varxb.setI3Xb16(dataset.get("I3xb_16")/100);
        varxb.setI3Xb17(dataset.get("I3xb_17")/100);
        varxb.setI3Xb18(dataset.get("I3xb_18")/100);
        varxb.setI3Xb19(dataset.get("I3xb_19")/100);
        varxb.setI3Xb20(dataset.get("I3xb_20")/100);
        varxb.setI3Xb21(dataset.get("I3xb_21")/100);
        varxb.setI3Xb22(dataset.get("I3xb_22")/100);
        varxb.setI3Xb23(dataset.get("I3xb_23")/100);
        varxb.setI3Xb24(dataset.get("I3xb_24")/100);
        varxb.setI3Xb25(dataset.get("I3xb_25")/100);
        varxb.setI3Xb26(dataset.get("I3xb_26")/100);
        varxb.setI3Xb27(dataset.get("I3xb_27")/100);
        varxb.setI3Xb28(dataset.get("I3xb_28")/100);
        varxb.setI3Xb29(dataset.get("I3xb_29")/100);
        varxb.setI3Xb30(dataset.get("I3xb_30")/100);
        varxb.setI3Xb31(dataset.get("I3xb_31")/100);
        varxb.setI3Xb32(dataset.get("I3xb_32")/100);
        varxb.setI3Xb33(dataset.get("I3xb_33")/100);
        varxb.setI3Xb34(dataset.get("I3xb_34")/100);
        varxb.setI3Xb35(dataset.get("I3xb_35")/100);
        varxb.setI3Xb36(dataset.get("I3xb_36")/100);
        varxb.setI3Xb37(dataset.get("I3xb_37")/100);
        varxb.setI3Xb38(dataset.get("I3xb_38")/100);
        varxb.setI3Xb39(dataset.get("I3xb_39")/100);
        varxb.setI3Xb40(dataset.get("I3xb_40")/100);
        varxb.setI3Xb41(dataset.get("I3xb_41")/100);
        varxb.setI3Xb42(dataset.get("I3xb_42")/100);
        varxb.setI3Xb43(dataset.get("I3xb_43")/100);
        varxb.setI3Xb44(dataset.get("I3xb_44")/100);
        varxb.setI3Xb45(dataset.get("I3xb_45")/100);
        varxb.setI3Xb46(dataset.get("I3xb_46")/100);
        varxb.setI3Xb47(dataset.get("I3xb_47")/100);
        varxb.setI3Xb48(dataset.get("I3xb_48")/100);
        varxb.setI3Xb49(dataset.get("I3xb_49")/100);
        varxb.setI3Xb50(dataset.get("I3xb_50")/100);
        ...
        if (dataset.get("I1xb_1") > 0) {
            cos1 = dataset.get("PF1") * dataset.get("I1") / dataset.get("I1xb_1");
        }
        if (dataset.get("I2xb_1") > 0) {
            cos2 = dataset.get("PF2") * dataset.get("I2") / dataset.get("I2xb_1");
        }
        if (dataset.get("I3xb_1") > 0) {
            cos3 = dataset.get("PF3") * dataset.get("I3") / dataset.get("I3xb_1");
        }

        var.setCosPhi1((float)cos1);
        var.setCosPhi2((float)cos2);
        var.setCosPhi3((float)cos3);
    ...
    public static void setDic(List<Dictionary> dic) {
        DataOnline.dic = dic;
    }

    public static List<DictionaryPlus> getDicPlus() {
        return dicPlus;
    }

    public static void setDicPlus(List<DictionaryPlus> dicPlus) {
...
//    public static Map<String,String[]> getMysql() {
//        return mysql;
//    }
}
