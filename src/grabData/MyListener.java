...
import webServiceAPI.service.WebServicePublish;
    ...
    public void contextInitialized(ServletContextEvent e) {
        Thread dataThread = new Thread() {
            ...
            public void run() {
                ...
                ReadXmlFile.paserXML();
                //发布外部访问接口
                WebServicePublish.main(null);
                      ...
                      /*  Calendar calendar = Calendar.getInstance();
                        ...
                        Trigger trigger10 = newTrigger()
                                ...
                                .withSchedule(simpleSchedule()
                                        .withIntervalInSeconds(listbase.get(0).getDatainterval())
                                        .repeatForever())
                                .build();
                        ...
                        Trigger trigger6 = newTrigger()
                                ...
                                .withPriority(8)
                                .withSchedule(simpleSchedule()
                                        .withIntervalInSeconds(listbase.get(0).getTempinterval())
                                        .repeatForever())
                                .build();
                        ...
                        Trigger trigger2 = newTrigger()
                                ...
                                .withSchedule(simpleSchedule()
                                        .withIntervalInMinutes(
                                                listbase.get(0).getThansentinterval())
                                        .repeatForever())
                                .build();
                        ...
                        Trigger trigger7 = newTrigger()
                                ...
                                .withPriority(5)
                                .withSchedule(simpleSchedule()
                                        .withIntervalInSeconds(listbase.get(0).getCtrlinterval())
                                        .repeatForever()).build();
                        ...
                        Trigger trigger5 = newTrigger()
                                ...
                                .withPriority(4)
                                .withSchedule(simpleSchedule()
                                        .withIntervalInMinutes(listbase.get(0).getAlarminterval())
                                        .repeatForever())
                                .build();
                        ...
                        Trigger trigger4 = newTrigger()
                                ...
                                .withPriority(3)
                                .withSchedule(simpleSchedule()
                                        .withIntervalInMinutes(listbase.get(0).getAssessinterval())
                                        .repeatForever())
                                .build();
...
////                        server.start(new InetSocketAddress(9999));
                        ...
                        Trigger trigger99 = (SimpleTrigger) newTrigger()
                                ...
                                .startAt(
                                        DateBuilder.futureDate(15, DateBuilder.IntervalUnit.SECOND))
                                .build();
