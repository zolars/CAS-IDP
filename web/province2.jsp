        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < didlist.length; i++) {
                    ...
                    name.innerHTML += ('<td style="padding-right: 50px;font-size: 4%;color: #000000">' + namelist[i] + '</td>');

                    if (rtlist[i] === "正常")
                        status.innerHTML += ('<td style="padding-right: 50px;font-size: 4%;color: #000000";text-align:center;>良好</td>');
                    else {
                ...
                for (var i = 0; i < didlist2.length; i++) {
                    ...
                    name2.innerHTML += ('<td style="font-size: 5%;color: #000000">' + namelist2[i] + '</td>');

                    if (rtlist2[i] === "正常")
                        status2.innerHTML += ('<td style="font-size: 5%;color: #000000";align:center;>良好</td>');
                    else {
